...
We can use **queryRenderedFeatures()** to get an array of _GeoJSON Feature objects_ **** from the **layer** we are on, using visible features that satisfy the query parameters (**geometry**):
...
<figure><img src="../.gitbook/assets/Custom-select.png" alt=""><figcaption><p>Instead of box on drag we use 2 click boxes</p></figcaption></figure>

<details>

<summary>Custom 2 points box for query feature events</summary>
...
<figure><img src="../.gitbook/assets/filterCounty.png" alt=""><figcaption><p>Instead of using an area in Features we use the source to filter</p></figcaption></figure>

<details>

<summary>Filter features containing using its data</summary>
...
<figure><img src="../.gitbook/assets/terrain.png" alt=""><figcaption><p>we can also exagerate the heigths</p></figcaption></figure>
