...
* [PostgreSQL base custom data type](custom-range-and-base-data-types-and-postgresql-binary-data.md#postgresql-base-custom-data-type)
* [PostgreSQL binary data storage and SQL standard syntax](custom-range-and-base-data-types-and-postgresql-binary-data.md#postgresql-binary-data-storage-and-sql-standard-syntax)
...
ENUM Custom data types were exaplined in the [SQL data Types section](sql-scalar-table-data-types.md#enum-and-array).
